...
export const projects = [
    {
        ...
        links: [{ label: "GitHub", url: "https://github.com/anujbis2006/Multimodel_fake_news", icon: "github" }],
    ...
    },
    {
        ...
        links: [{ label: "Live", url: "https://gitlens-ai-o315.onrender.com", icon: "external" }],
    ...
    },
    {
        ...
        links: [{ label: "GitHub", url: "https://github.com/anujbis2006/Resume-analyser", icon: "github" }],
